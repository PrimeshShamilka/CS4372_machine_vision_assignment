...
if __name__ == "__main__":
    ...
    images = [cv2.imread("/media/primesh/F4D0EA80D0EA4906/ACADEMICS/MORA/Sem 7/Machine vision/canny_edge_detector/canny_edge_detector/faces_imgs/lena.png",0)]
    ...
    for i in range(len(images)):
        ...
        cv2.imwrite("lena" + "_canny_edge.jpg", img_final)